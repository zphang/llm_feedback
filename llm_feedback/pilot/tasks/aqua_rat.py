...
class AQUARATTask(BaseTask):
    ...
    def get_chain(self, generation_llm: str, feedback_llm: str, refinement_llm: str,
        ...
        The following is a math problem. Reason through the problem step-by-step, putting each separate reasoning step on a new numbered line (e.g. "Step 1. ") and finally respond with the right answer. Put the final answer letter on a single line with the format "The answer is: (option), number" (e.g. "The answer is: (a), 1").
